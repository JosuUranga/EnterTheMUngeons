...
void InitSurfacesAndTextures(void){
	...
	mt.texturak[0] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[0]);
	mt.surface[1] = IMG_Load("resources/Characters/enemigo1.png");
	mt.texturak[1] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[1]);
	mt.surface[2] = IMG_Load("resources/Characters/enemigo.png");
	mt.texturak[2] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[2]);
	mt.surface[3] = IMG_Load("resources/Maps/Kredituak.png");
	mt.texturak[3] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[3]);
	mt.surface[4] = IMG_Load("resources/Maps/MenuES.png");
	mt.texturak[4] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[4]);
	mt.surface[5] = IMG_Load("resources/Maps/MenuEN.png");
	mt.texturak[5] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[5]);

	mt.surface[6] = IMG_Load("resources/Maps/KredituakES.png");
	mt.texturak[6] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[6]);

	mt.surface[7] = IMG_Load("resources/Maps/KredituakEN.png");
	mt.texturak[7] = SDL_CreateTextureFromSurface(TakeRenderer(), mt.surface[7]);
	...
	lifestruct.life_texture[0] = SDL_CreateTextureFromSurface(TakeRenderer(), lifestruct.life_surface[0]);
	lifestruct.life_texture[1] = SDL_CreateTextureFromSurface(TakeRenderer(), lifestruct.life_surface[1]);
	lifestruct.life_texture[2] = SDL_CreateTextureFromSurface(TakeRenderer(), lifestruct.life_surface[2]);
	lifestruct.life_texture[3] = SDL_CreateTextureFromSurface(TakeRenderer(), lifestruct.life_surface[3]);
	lifestruct.life_texture[4] = SDL_CreateTextureFromSurface(TakeRenderer(), lifestruct.life_surface[4]);
	lifestruct.life_texture[5] = SDL_CreateTextureFromSurface(TakeRenderer(), lifestruct.life_surface[5]);

	winOrDie.surface[0] = IMG_Load("resources/Maps/YouWinEUS.png");
	winOrDie.texture[0] = SDL_CreateTextureFromSurface(TakeRenderer(), winOrDie.surface[0]);
	winOrDie.surface[1] = IMG_Load("resources/Maps/YouWinES.png");
	winOrDie.texture[1] = SDL_CreateTextureFromSurface(TakeRenderer(), winOrDie.surface[1]);
	winOrDie.surface[2] = IMG_Load("resources/Maps/YouWinEN.png");
	winOrDie.texture[2] = SDL_CreateTextureFromSurface(TakeRenderer(), winOrDie.surface[2]);
	winOrDie.surface[3] = IMG_Load("resources/Maps/GameOverEUS.png");
	winOrDie.texture[3] = SDL_CreateTextureFromSurface(TakeRenderer(), winOrDie.surface[3]);
	winOrDie.surface[4] = IMG_Load("resources/Maps/GameOverES.png");
	winOrDie.texture[4] = SDL_CreateTextureFromSurface(TakeRenderer(), winOrDie.surface[4]);
	winOrDie.surface[5] = IMG_Load("resources/Maps/GameOverEN.png");
	winOrDie.texture[5] = SDL_CreateTextureFromSurface(TakeRenderer(), winOrDie.surface[5]);

	for (int i = 0; i < 13; i++)
	{
		dooropenstruct.texturak[i] = SDL_CreateTextureFromSurface(TakeRenderer(), dooropenstruct.surface[i]);
	...
	for (int i = 0; i < 11; i++) {
		doorclosetruct.texturak[i] = SDL_CreateTextureFromSurface(TakeRenderer(), doorclosetruct.surface[i]);
	...
	charactersstruct.player_texture = SDL_CreateTextureFromSurface(TakeRenderer(), charactersstruct.player_surface);
	charactersstruct.playerInvencivility_texture = SDL_CreateTextureFromSurface(TakeRenderer(), charactersstruct.playerInvencivility_surface);
	charactersstruct.playerBullet_texture = SDL_CreateTextureFromSurface(TakeRenderer(), charactersstruct.playerBullet_surface);

	marco.surface[0] = IMG_Load("resources/marco1.png");
	marco.texture[0] = SDL_CreateTextureFromSurface(TakeRenderer(), marco.surface[0]);
	marco.surface[1] = IMG_Load("resources/marco2.png");
	marco.texture[1] = SDL_CreateTextureFromSurface(TakeRenderer(), marco.surface[1]);

	//ARMAS CAMBIAR
	marco.surface[2] = IMG_Load("resources/ShotgunSelected.png");
	marco.texture[2] = SDL_CreateTextureFromSurface(TakeRenderer(), marco.surface[2]);
	marco.surface[3] = IMG_Load("resources/SniperSelected.png");
	marco.texture[3] = SDL_CreateTextureFromSurface(TakeRenderer(), marco.surface[3]);



	boss.bossHealthSur[0] = IMG_Load("resources/Bosses/bossHealth.jpg");
	boss.bossHealthTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossHealthSur[0]);

	boss.bossHealthSur[1] = IMG_Load("resources/Bosses/cuadradoamarillo.jpg");
	boss.bossHealthTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossHealthSur[1]);

	boss.bossHealthSur[2] = IMG_Load("resources/Bosses/color-azul.png");
	boss.bossHealthTex[2] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossHealthSur[2]);

	//Boss Lava
	boss.bossSur[0] = IMG_Load("resources/Bosses/lavaBoss.png");
	boss.bossTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[0]);
	...
	lava.lavaTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), lava.lavaSur[0]);
	lava.lavaSur[1] = IMG_Load("resources/Bosses/Tiros/lava.png");
	lava.lavaTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), lava.lavaSur[1]);
	lava.lavaSur[2] = IMG_Load("resources/healthBar.png");
	lava.lavaTex[2] = SDL_CreateTextureFromSurface(TakeRenderer(), lava.lavaSur[2]);
	...
	boss.bossTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[1]);
	...
	esq.esqTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), esq.esqSur[0]);
	esq.esqSur[1] = IMG_Load("resources/Bosses/Tiros/default.png");
	esq.esqTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), esq.esqSur[1]);
	...
	boss.bossTex[2] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[2]);
	...
	nieve.nieveTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), nieve.nieveSur[0]);
	nieve.nieveSur[1] = IMG_Load("resources/Bosses/Tiros/nieve.png");
	nieve.nieveTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), nieve.nieveSur[1]);
	...
	boss.bossTex[3] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[3]);
	...
	arbol.arbolTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), arbol.arbolSur[0]);
	arbol.arbolSur[1] = IMG_Load("resources/Bosses/Tiros/verde.png");
	arbol.arbolTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), arbol.arbolSur[1]);
	...
	boss.bossTex[4] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[4]);
	boss.bossSur[5] = IMG_Load("resources/Bosses/FinalBoss/finalBoss2.png");
	boss.bossTex[5] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[5]);
	boss.bossSur[6] = IMG_Load("resources/Bosses/FinalBoss/finalBoss3.png");
	boss.bossTex[6] = SDL_CreateTextureFromSurface(TakeRenderer(), boss.bossSur[6]);

	final.finalSur[0] = IMG_Load("resources//Bosses/FinalBoss/final1.png");
	final.finalTex[0] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[0]);
	final.finalSur[1] = IMG_Load("resources//Bosses/FinalBoss/final2.png");
	final.finalTex[1] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[1]);
	final.finalSur[2] = IMG_Load("resources//Bosses/FinalBoss/final1.png");
	final.finalTex[2] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[2]);
	final.finalSur[3] = IMG_Load("resources//Bosses/FinalBoss/final2.png");
	final.finalTex[3] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[3]);
	final.finalSur[4] = IMG_Load("resources//Bosses/FinalBoss/final1.png");
	final.finalTex[4] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[4]);
	final.finalSur[5] = IMG_Load("resources//Bosses/FinalBoss/final2.png");
	final.finalTex[5] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[5]);
	final.finalSur[6] = IMG_Load("resources//Bosses/FinalBoss/final1.png");
	final.finalTex[6] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[6]);
	final.finalSur[7] = IMG_Load("resources//Bosses/FinalBoss/final2.png");
	final.finalTex[7] = SDL_CreateTextureFromSurface(TakeRenderer(), final.finalSur[7]);
	...
	levelAnim.lavaTexture[1] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.lavaSurface[1]);
	levelAnim.lavaTexture[5] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.lavaSurface[5]);
	levelAnim.lavaTexture[6] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.lavaSurface[6]);
	...
	levelAnim.snowTexture[0] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[0]);
	levelAnim.snowTexture[1] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[1]);
	levelAnim.snowTexture[2] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[2]);
	levelAnim.snowTexture[3] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[3]);
	levelAnim.snowTexture[4] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[4]);
	levelAnim.snowTexture[5] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[0]);
	levelAnim.snowTexture[6] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[1]);
	levelAnim.snowTexture[7] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[2]);
	levelAnim.snowTexture[8] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[3]);
	levelAnim.snowTexture[9] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.snowSurface[4]);
	...
	levelAnim.defaultTexture[0] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[0]);
	levelAnim.defaultTexture[1] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[1]);
	levelAnim.defaultTexture[2] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[2]);
	levelAnim.defaultTexture[3] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[3]);
	levelAnim.defaultTexture[4] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[4]);
	levelAnim.defaultTexture[5] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[5]);
	levelAnim.defaultTexture[6] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[6]);
	levelAnim.defaultTexture[7] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[7]);
	levelAnim.defaultTexture[8] = SDL_CreateTextureFromSurface(TakeRenderer(), levelAnim.defaultSurface[8]);
