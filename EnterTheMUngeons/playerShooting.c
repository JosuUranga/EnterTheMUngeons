...
void AllyBulletCreation(SDL_Rect* dest, SDL_Rect* Bala, ProtaBullet* ProtaB) {
	...
	if (buttons && SDL_BUTTON(SDL_BUTTON_LEFT)) {
		if ((*ProtaB).aBulletCreated == 0) {
			...
			(*ProtaB).aBulletDelta_x = (mouse_x - (*Bala).w / 2) - (*Bala).x;
			(*ProtaB).aBulletDelta_y = (mouse_y - (*Bala).h / 2) - (*Bala).y;
			distance = sqrt((*ProtaB).aBulletDelta_x*(*ProtaB).aBulletDelta_x + (*ProtaB).aBulletDelta_y*(*ProtaB).aBulletDelta_y);
			(*ProtaB).aBulletVel_x = ((*ProtaB).aBulletDelta_x*(ABSpeed)) / distance;
			(*ProtaB).aBulletVel_y = ((*ProtaB).aBulletDelta_y*(ABSpeed)) / distance;
			(*ProtaB).aBulletPos_x = (*Bala).x;
			(*ProtaB).aBulletPos_y = (*Bala).y;
